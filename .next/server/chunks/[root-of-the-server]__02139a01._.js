...
"[project]/.next-internal/server/app/api/developers/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/data/mockDeveloperData.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/services/developers/getDevelopersByCity.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getDevelopersByCity": (()=>getDevelopersByCity)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockDeveloperData.ts [app-route] (ecmascript)");
;
const getDevelopersByCity = (city)=>{
    const developers = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].filter((developer)=>developer.city === city);
    return developers;
};
}}),
"[project]/services/developers/getDevelopersByCountry.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getDevelopersByCountry": (()=>getDevelopersByCountry)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockDeveloperData.ts [app-route] (ecmascript)");
;
const getDevelopersByCountry = (country)=>{
    const developers = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].filter((developer)=>developer.country === country);
    return developers;
};
}}),
"[project]/services/developers/getDevelopersByState.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getDevelopersByState": (()=>getDevelopersByState)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockDeveloperData.ts [app-route] (ecmascript)");
;
const getDevelopersByState = (state)=>{
    const developers = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].filter((developer)=>developer.state === state);
    return developers;
};
}}),
...
"[project]/constants/roles.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/services/developers/getDevelopersByRole.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getDevelopersByRole": (()=>getDevelopersByRole)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockDeveloperData.ts [app-route] (ecmascript)");
;
const getDevelopersByRole = (role)=>{
    const developers = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDeveloperData$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].filter((developer)=>developer.title === role);
    return developers;
};
}}),
"[project]/app/api/developers/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByCity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/developers/getDevelopersByCity.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByCountry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/developers/getDevelopersByCountry.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/developers/getDevelopersByState.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$roles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/roles.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByRole$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/developers/getDevelopersByRole.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(request) {
    ...
    if (country) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByCountry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDevelopersByCountry"])(country));
    }
    if (state) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByState$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDevelopersByState"])(state));
    }
    if (city) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByCity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDevelopersByCity"])(city));
    }
    if (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$roles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].includes(role)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$developers$2f$getDevelopersByRole$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDevelopersByRole"])(role));
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'country, city or state parameter is required'
    }, {
        status: 400
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02139a01._.js.map