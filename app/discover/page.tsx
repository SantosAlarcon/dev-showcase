...
const allDevelopers = [
    ...
    },
    {
        ...
        experience: "5 years",
        availability: "Full-time",
        avatar: "https://images.pexels.com/photos/3778603/pexels-photo-3778603.jpeg?auto=compress&cs=tinysrgb&w=600",
        coverImage:
    ...
    },
    {
        ...
        experience: "8 years",
        availability: "Contract",
        avatar: "https://images.pexels.com/photos/1102341/pexels-photo-1102341.jpeg?auto=compress&cs=tinysrgb&w=600",
        coverImage:
    ...
    const applyFilters = () => {
        ...
        if (selectedExperience !== "Any") {
            if (selectedExperience === "1-2 years") {
                results = results.filter(
                    (dev) => parseInt(dev.experience) <= 2,
                );
            } else if (selectedExperience === "3-5 years") {
                results = results.filter(
                    (dev) =>
                        parseInt(dev.experience) >= 3 &&
                        parseInt(dev.experience) <= 5,
                );
            } else if (selectedExperience === "5+ years") {
                results = results.filter(
                    (dev) => parseInt(dev.experience) >= 5,
                );
            }
        }
