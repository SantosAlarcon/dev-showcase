...
export const appwriteDevelopersCollectionId = process.env.NEXT_PUBLIC_APPWRITE_DEVELOPERS_COLLECTION_ID;
export const appwriteProjectsCollectionId = process.env.NEXT_PUBLIC_APPWRITE_PROJECTS_COLLECTION_ID;
